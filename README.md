...
**Current version:** `v0.0.113` (see [`VERSION`](VERSION) and Unity **Player Settings → Version**).
...
| Version | Summary |
|---------|---------|
| **v0.0.113** | Add special effect console logs, fix skeleton block, and polish equipment visuals |
